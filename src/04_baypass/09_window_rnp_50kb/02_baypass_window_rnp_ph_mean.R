...
# Load windows
load("data/processed/baypass/window_summary/windows_50kb.RData")
...
bf.ph.mean.sum$rank <- rank(-bf.ph.mean.sum$bf_db.mean)
Lp <- length(bf.ph.mean.sum$bf_db.mean)
bf.ph.mean.sum$rnp <- bf.ph.mean.sum$rank/Lp
...
folder_name <- paste("data/processed/baypass/window_summary/window_50kb_chunk_analysis_ph_mean")
