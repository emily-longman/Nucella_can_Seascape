...
pdf("output/figures/baypass/window_summary/baypass_ph_mean_xtx_topwin.pdf", width = 10, height = 4)
...
pdf("output/figures/baypass/window_summary/baypass_ph_mean_xtx_corrected_topwin.pdf", width = 10, height = 4)
...
pdf("output/figures/baypass/window_summary/baypass_ph_mean_xtx_topwin_geomline.pdf", width = 10, height = 4)
