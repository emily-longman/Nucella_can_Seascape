...
bf.ph.scaled.mean.sum$rank <- rank(-bf.ph.scaled.mean.sum$bf_db.mean)
Lp <- length(bf.ph.scaled.mean.sum$bf_db.mean)
bf.ph.scaled.mean.sum$rnp <- bf.ph.scaled.mean.sum$rank/Lp
...
folder_name <- paste("data/processed/baypass/window_summary/window_100kb_chunk_analysis_ph_mean_scaled")
