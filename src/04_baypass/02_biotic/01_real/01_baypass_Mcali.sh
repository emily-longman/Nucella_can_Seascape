...
# Name this job
#SBATCH --job-name=baypass_biotic_Mcali
...
var_names=$WORKING_FOLDER/guide_files/Mcali_vars_names.txt
guide_file=$WORKING_FOLDER/guide_files/Baypass_biotic_Mcali.txt
