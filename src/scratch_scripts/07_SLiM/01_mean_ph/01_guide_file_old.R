...
#k <- seq(0.01, 0.10, by = 0.005) #13
#k <- seq(0.11, 0.20, by = 0.005) #13
k <- seq(0.21, 0.30, by = 0.005) #13
mag <- c(1) #1
m <- c(0.0001) #1
N <- c(5000) #1

# Make every combination of variables - 475 combos
guide_file_morevars9_expand2 <- expand.grid(thresh, k, mag, m, N)

# Write table
write.table(guide_file_morevars9_expand2, file = "guide_files/slim_ph_guide_file_morevars9_expand2.txt", sep = "\t", quote = FALSE, row.names=F, col.names=F)
...
#k <- seq(0.11, 0.20, by = 0.005) #13
#k <- seq(0.21, 0.30, by = 0.005) #13
k <- seq(0.31, 0.40, by = 0.005) #13
mag <- c(1) #1
m <- c(0.0001) #1
N <- c(5000) #1

# Make every combination of variables - 475 combos
guide_file_morevars9_expand3 <- expand.grid(thresh, k, mag, m, N)
