...
# Name this job
#SBATCH --job-name=baypass_omega_subset18pop
...
if [ -d "omega_subset18pop" ]
then echo "Working omega_subset18pop folder exist"; echo "Let's move on."; date
else echo "Working omega_subset18pop folder doesnt exist. Let's fix that."; mkdir $WORKING_FOLDER/data/processed/baypass/omega_subset18pop; date
fi

#--------------------------------------------------------------------------------

# Change directory 
cd $WORKING_FOLDER/data/processed/baypass/omega_subset18pop
...
-d0yij 4 \
-outprefix NC_subset18pop_baypass \
