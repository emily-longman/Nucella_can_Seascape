...
# Name this job
#SBATCH --job-name=Mcali_ABC_SimData_launch
...
# This part of the script will check and generate, if necessary, all of the output folders used in the script
if [ -d "Mcali_ABC" ]
then echo "Working Mcali_ABC folder exist"; echo "Let's move on."; date
else echo "Working Mcali_ABC folder doesnt exist. Let's fix that."; mkdir $WORKING_FOLDER/data/processed/SLiM/Mcali_ABC; date
fi

#--------------------------------------------------------------------------------

# Run R script
Rscript --vanilla $WORKING_FOLDER/src/06_SLiM/02_Mcali/03_ABC_SimData.R
