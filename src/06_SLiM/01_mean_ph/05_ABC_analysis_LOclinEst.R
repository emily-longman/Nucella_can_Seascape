...
# Graph sim
pdf("output/figures/SLiM/ph_ABC/sim_AFs_best_morevars9_all_nop4.pdf", width = 5, height = 5)
...
# Graph sim
pdf("output/figures/SLiM/ph_ABC/sim_AFs_best_repmeans_morevars9_all_nop4.pdf", width = 5, height = 5)
