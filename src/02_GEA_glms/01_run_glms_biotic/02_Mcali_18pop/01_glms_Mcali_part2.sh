...
#SBATCH --time=5:00:00 #for real #30:00:00 for perm
...
# Submit job array
#SBATCH --array=901-996 #501-900%75 #996 Still need last chunk
...
# Script folder.
SCRIPT_FOLDER=$WORKING_FOLDER/src/02_GEA_glms/01_run_glms_biotic/02_Mcali_18pop
