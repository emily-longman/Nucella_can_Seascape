...
wins_sum <- foreach(perm.i=0:100,.combine="rbind", .errorhandling="remove")%do%{ 
...
folder_name <- paste("data/processed/GEA/glms/glms_window_summary/glms_window_chunk_analysis_Mtross_mean")
