...
# Name this job
#SBATCH --job-name=glms_window_rnp_nSNP50
...
if [ -d "glms_window_chunk_analysis_ph_mean_real_filt_nSNP" ]
then echo "Working glms_window_chunk_analysis_ph_mean_real_filt_nSNP folder exist"; echo "Let's move on."; date
else echo "Working glms_window_chunk_analysis_ph_mean_real_filt_nSNP folder doesnt exist. Let's fix that."; mkdir $WORKING_FOLDER/data/processed/GEA/glms/glms_window_summary/glms_window_chunk_analysis_ph_mean_real_filt_nSNP; date
fi
