...
# Graph SNP density
pdf("output/figures/GEA/glms/glms_window_summary/glm_chr_nSNP_density.pdf", width = 8, height = 8)
...
# Graph SNP density
pdf("output/figures/GEA/glms/glms_window_summary/glm_chr_nSNP_filt_density.pdf", width = 8, height = 8)
...
# Group the backbone names into 1000 (Note: 12928 wins /1000 array = 12.9; 12318/1000 array = 12.3)
