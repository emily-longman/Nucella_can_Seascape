...
# Submit job array
#SBATCH --array=151-256 #1-150 #1-256
...
# This part of the script will check and generate, if necessary, all of the output folders used in the script
if [ -d "Mcali_results" ]
then echo "Working Mcali_results folder exist"; echo "Let's move on."; date
else echo "Working Mcali_results folder doesnt exist. Let's fix that."; mkdir $WORKING_FOLDER/data/processed/SLiM/Mcali_results; date
fi
