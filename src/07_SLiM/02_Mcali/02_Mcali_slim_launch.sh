...
# Submit job array
#SBATCH --array=401-806 #1-400 #1-806
...
# This part of the script will check and generate, if necessary, all of the output folders used in the script
if [ -d "Mcali_results_v3" ]
then echo "Working Mcali_results_v3 folder exist"; echo "Let's move on."; date
else echo "Working Mcali_results_v3 folder doesnt exist. Let's fix that."; mkdir $WORKING_FOLDER/data/processed/SLiM/Mcali_results_v3; date
fi
...
# Set root
ROOT=$WORKING_FOLDER/data/processed/SLiM/Mcali_results_v3

#--------------------------------------------------------------------------------

# Change directory
cd $WORKING_FOLDER/data/processed/SLiM/Mcali_results_v3
