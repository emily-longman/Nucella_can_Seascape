...
k <- seq(0.01, 0.10, by = 0.005) #13
mag <- c(1) #1
m <- c(0.0001, 0.00001) #1
N <- c(5000) #1

# Make every combination of variables - 950 combos
guide_file_morevars7_lowerm <- expand.grid(thresh, k, mag, m, N)

# Write table
write.table(guide_file_morevars7_lowerm, file = "guide_files/guide_file_morevars7_lowerm.txt", sep = "\t", quote = FALSE, row.names=F, col.names=F)
