...
# Name this job
#SBATCH --job-name=ph_future_vary_N
...
if [ -d "ph_vary_N" ]
then echo "Working ph_vary_N folder exist"; echo "Let's move on."; date
else echo "Working ph_vary_N folder doesnt exist. Let's fix that."; mkdir $WORKING_FOLDER/data/processed/SLiM/ph_future/ph_vary_N; date
fi

# This part of the script will check and generate, if necessary, all of the output folders used in the script
if [ -d "N_${N}" ]
then echo "Working N_${N} folder exist"; echo "Let's move on."; date
else echo "Working N_${N} folder doesnt exist. Let's fix that."; mkdir $WORKING_FOLDER/data/processed/SLiM/ph_future/ph_vary_N/N_${N}; date
fi
