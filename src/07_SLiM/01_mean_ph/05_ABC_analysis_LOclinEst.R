...
sim_All <- rbind(sim_All_pt1, sim_All_pt2)
...
# Graph sim
pdf("output/figures/SLiM/ph_ABC/sim_AFs_best_morevars9_all.pdf", width = 5, height = 5)
...
# Graph sim
pdf("output/figures/SLiM/ph_ABC/sim_AFs_best_repmeans_morevars9_all.pdf", width = 5, height = 5)
