...
ggplot(baypass.bf[which(baypass.bf$variable == "ph_mean" & bf_db > 0),], aes(y=bf_db, x=chr)) + 
...
ggplot(baypass.bf[which(baypass.bf$variable == "thetao_mean"),], aes(y=bf_db, x=chr)) + 
  labs(x = "Position", y = "BF (in dB)") +
  geom_point(alpha=0.8) + 
  theme_classic(base_size = 20) + 
  theme(panel.spacing = unit(0.5, "lines"),
...
ggplot(baypass.bf[which(baypass.bf$variable == "chl_mean"),], aes(y=bf_db, x=chr)) + 
  labs(x = "Position", y = "BF (in dB)") +
  geom_point(alpha=0.8) + 
  theme_classic(base_size = 20) + 
  theme(panel.spacing = unit(0.5, "lines"),
...
ggplot(baypass.bf[which(baypass.bf$variable == "so_mean"),], aes(y=bf_db, x=chr)) + 
  labs(x = "Position", y = "BF (in dB)") +
  geom_point(alpha=0.8) + 
  theme_classic(base_size = 20) + 
  theme(panel.spacing = unit(0.5, "lines"),
