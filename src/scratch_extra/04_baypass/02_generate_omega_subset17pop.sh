...
# Name this job
#SBATCH --job-name=baypass_omega_subset17pop
...
if [ -d "omega_subset17pop" ]
then echo "Working omega_subset17pop folder exist"; echo "Let's move on."; date
else echo "Working omega_subset17pop folder doesnt exist. Let's fix that."; mkdir $WORKING_FOLDER/data/processed/baypass/omega_subset17pop; date
fi

#--------------------------------------------------------------------------------

# Change directory 
cd $WORKING_FOLDER/data/processed/baypass/omega_subset17pop
...
-d0yij 4 \
-outprefix NC_subset17pop_baypass \
