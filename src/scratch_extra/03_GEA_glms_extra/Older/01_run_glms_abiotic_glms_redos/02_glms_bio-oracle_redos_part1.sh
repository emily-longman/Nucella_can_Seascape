...
# Submit job array
#SBATCH --array=724,725,726,727,728,729,730,732,733,734,735,736,737,738,739,740,741,743,765,767,771,780,781,785,788,790,798,802,803,809,820,825,840,845,846
...
# Script folder.
SCRIPT_FOLDER=$WORKING_FOLDER/src/02_GEA_glms/01_run_glms
