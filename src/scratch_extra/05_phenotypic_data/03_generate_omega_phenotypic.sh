...
# Name this job
#SBATCH --job-name=baypass_omega_phenotypic
...
else echo "Working omega folder doesnt exist. Let's fix that."; mkdir $WORKING_FOLDER/data/processed/phenotypic_data/omega; date
fi

#--------------------------------------------------------------------------------

# Change directory 
cd $WORKING_FOLDER/data/processed/phenotypic_data/omega
